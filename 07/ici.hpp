...
class Intcode_interpreter
{
	public:
		...
		std::queue<ici_t> input_queue; //Queue of values that will be used instead of asking on the command line
		std::queue<ici_t> last_outputs; //Queue of last output values
